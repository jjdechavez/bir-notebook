...
import { listUsers, upsertUserProfile, getUserWithProfile } from "../services/users.js";
import { serializeUserDetail } from "../serializers/user.js";
import { buildPaginationMeta } from "../utils/pagination.js";

export const listUsersHandler = requireAuth(async (event) => {
...
export const updateUserHandler = requireAuth(async (event) => {
