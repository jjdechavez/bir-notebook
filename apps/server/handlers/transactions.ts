...
export const createTransactionHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    try {
...
export const showTransaction = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
...
export const updateTransactionHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    const params = getRouterParams(event);
    const validate = await readValidatedBody(
...
export const recordTransactionHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    const params = getRouterParams(event);
...
export const undoRecordTransactionHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    const params = getRouterParams(event);
...
export const bulkTransferToGeneralLedgerHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    const payload = bulkTransferToGeneralLedgerSchema.parse(
...
export const transferHistoryHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
...
export const generalLedgerViewHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
...
export const generalLedgerEntriesHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    const payload = generalLedgerEntriesSchema.parse(getQuery(event));
...
export const updateGlDescriptionHandler = defineEventHandler({
  onRequest: [requireAuth()],
  handler: async (event) => {
    try {
      const params = getRouterParams(event);
